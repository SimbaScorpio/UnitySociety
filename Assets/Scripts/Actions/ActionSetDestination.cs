...
public class ActionSetDestination : ActionMultiple, ActionCompleted
{
	...
	public void Setting (GameObject obj, Vector3 targetPosition, ActionCompleted callback)
	{
		this.obj = obj;
	...
	public void OnActionCompleted (Action ac)
	{
		...
		case ActionID.TAKEELEVATOR:
			ready = true;
			ActionManager.GetInstance ().ApplyMoveToAction (obj, targetPosition, ActionID.MOVETO, this);
			break;
		}
	}
}

...
public class GIFPlayer : MonoBehaviour
{
	...
	void Update ()
	{
		...
		display.GetComponent<Renderer> ().material.mainTexture = frames [index];
	}


	Image LoadImage ()
	{
		return Image.FromFile (Application.dataPath + "/Data/Compmov.gif");
	}
